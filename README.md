...
<ul>
  ...
  <li>Promote DC-1 to a Domain Controller and set up a new forest with a domain name (e.g., <code>my-domain.com</code>).</li>
  <li>Restart DC-1 after promotion and log in using the domain account: <code>my-domain.com\labuser001</code>.</li>
</ul>
...
<ul>
  ...
  <li>Create a new user named “John Wick” with the username <code>john_admin</code> and add her to the <strong>Domain Admins</strong> security group.</li>
  <li>Log out and back in to DC-1 as <code>mydomain.com\john_admin</code> to use this admin account moving forward.</li>
</ul>
...
<ul>
  ...
  <li>Login to Client-1 using the local admin account<code>labuser001</code>, and join it to the domain <code>my-domain.com</code>.</li>
...
<ul>
  <li>Log into DC-1 as <code>john_admin</code> and open PowerShell ISE as an administrator.</li>
